...
kafka-topics --delete --zookeeper localhost:2181 --topic com.sefidian.streams.users > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.sefidian.streams.purchases > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.sefidian.streams.users --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.sefidian.streams.purchases --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.sefidian.streams.pages > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.sefidian.streams.clickevents > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.sefidian.streams.pages --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.sefidian.streams.clickevents --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
