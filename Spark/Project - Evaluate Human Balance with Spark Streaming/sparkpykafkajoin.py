...
kafkaRedisServerDF.withColumn("value", from_json("value", kafkaRedisSchema)).select(
...
STEDIRiskScoreDF = customerRiskStreamingDF.join(
...
STEDIRiskScoreDF.writeStream.outputMode("append").format(
    "console"
