...
def checkpoint_exercise():
    ...
    """
    spark = (
        SparkSession.builder.master("local").appName("Checkpoint Example").getOrCreate()
    )
    ...
    stream_query = (
        rate_raw_data.writeStream.format("console")
        .queryName("Default")
        .option(
            "checkpointLocation", "hdfs://localhost:9010/checkpoints"
